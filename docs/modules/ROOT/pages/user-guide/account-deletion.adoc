...
La plateforme EXAI offre la possibilité de supprimer définitivement votre compte utilisateur. Cette fonctionnalité est disponible dans les paramètres de sécurité de votre profil utilisateur.
...
. Connectez-vous à votre compte EXAI
...
* Email : support@exai-platform.com
